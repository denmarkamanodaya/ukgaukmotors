...
@section('breadcrumbs')
    @if(isset($category))
        {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Blog' => '/members/posts', 'Category' => '/members/posts', $category->name => 'is_current']) !!}
    @elseif(isset($tag))
        {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Blog' => '/members/posts', 'Tag' => '/members/posts', $tag->name => 'is_current']) !!}
    @else
                                        ...
                                        <div class="col-lg-10 col-md-9 col-sm-12">
                                            @else
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    @endif
                                                    <div class="col-md-12 post-title"><h4><a href="{!! postLink($post, 'members') !!}">{{ $post->title }}</a></h4></div>
