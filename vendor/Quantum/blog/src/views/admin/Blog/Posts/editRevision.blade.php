        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body bg-info">
                    ...
                    <div class="col-md-4"><a href="{!! url('admin/post/'.$post->slug) !!}"><button class="btn btn-default btn-xs" type="button"><i class="far fa-retweet position-left"></i> Return To Original Post</button></a></div>
