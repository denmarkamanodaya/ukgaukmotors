    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div id="accordion-control-right" class="panel-group panel-group-control panel-group-control-right content-group-lg">
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse in" id="accordion-control-right-group1">
                        <div class="panel-body">
                            {!! Form::model($post, array('method' => 'POST', 'url' => '/admin/post/'.$post->slug.'/update', 'autocomplete' => 'off', 'id' => 'PostManage')) !!}
                ...
                @include('admin.Blog.Posts.partials.meta')
            </div>
        ...
        <div class="col-md-4">
                ...
                <div class="panel-body">
                            ...
                            <div class="content-group">
                                ...
                                <div id="publishTimeSelect">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{!! $post->publish_on->format('F jS Y H:i') !!}" name="publishDateTime" id="anytime-both" class="form-control" readonly="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Update Post<i class="far fa-save position-right"></i></button>
                        </div>
                        {!! Form::close() !!}
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <p>Showing Latest First</p>
                    ...
                    <div class="row mb-10">
                        <div class="col-md-6">
                            <div class="row">{{$revision->created_at->toDayDateTimeString()}}</div>
                        </div>
                        <div class="col-md-6">
            ...
            @if($drafts->count() > 0)
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title">Auto Saves</h6>
                        <div class="heading-elements">
                    ...
                    <div class="panel-body">
                        ...
                        @foreach($drafts as $draft)
                            <div class="row mb-10">
                                <div class="col-md-6">
                                    <div class="row">{{$draft->created_at->toDayDateTimeString()}}</div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row"><a href="{{url('admin/post/'.$post->slug.'/revision/'.$draft->id)}}">Show Draft Revision</a></div>
                                </div>
                            </div>
                        @endforeach
