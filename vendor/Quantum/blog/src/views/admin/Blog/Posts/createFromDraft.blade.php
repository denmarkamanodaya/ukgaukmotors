                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse in" id="accordion-control-right-group1">
                        <div class="panel-body">
                            {!! Form::model($postRevision,array('method' => 'POST', 'url' => '/admin/post/create', 'autocomplete' => 'off', 'id' => 'PostManage')) !!}
                    ...
                    <div class="panel-body">
                        ...
                        @foreach($drafts as $draft)
                            <div class="row mb-10">
                                ...
                                <div class="col-md-6">
                                    <div class="row"><a href="{{url('admin/post/createFromDraft/'.$draft->id)}}">Show Draft Revision</a></div>
                                </div>
                            </div>
                        @endforeach
