...
@section('breadcrumbs')
    {!! breadcrumbs(['Dashboard' => '/admin/dashboard', 'Categories' => '/admin/categories', $category->name => '/admin/category/'.$category->slug, $childCategory->name => 'is_current']) !!}
@stop
    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {!! Form::model($childCategory, array('method' => 'POST', 'url' => '/admin/category/'.$category->slug.'/child/'.$childCategory->slug.'/update', 'class' => 'form-horizontal', 'id' => 'category-update', 'autocomplete' => 'off')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        {!! Form::open(array('method' => 'POST', 'url' => '/admin/category/'.$category->slug.'/child/'.$childCategory->slug.'/delete', 'class' => 'form-horizontal', 'id' => 'category-update', 'autocomplete' => 'off')) !!}
