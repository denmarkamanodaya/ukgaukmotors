                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('featured_image', isset($post->meta->featured_image) ? $post->meta->featured_image : null, array('class' => 'form-control', 'id' => 'thumbnail')) !!}

                        </div>


                        <img id="holder" style="margin-top:15px;max-height:100px;" src="{!! isset($post->meta->featured_image) ? $post->meta->featured_image : null !!}">
