        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('ticket_public_received_page', 'Public Ticked Received Page:', ['class' => 'control-label col-lg-2']) !!}
                        <div class="col-lg-10">
                            {!! Form::select('ticket_public_received_page', $pages, Settings::get('ticket_public_received_page'), array('class' => 'form-control', 'id' => 'ticket_public_received_page', 'required')) !!}
                            {!!inputError($errors, 'ticket_public_received_page')!!}
                        </div>
                    </div>
