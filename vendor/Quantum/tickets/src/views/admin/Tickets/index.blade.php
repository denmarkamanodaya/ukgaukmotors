    ...
    <div class="navbar navbar-default navbar-component navbar-xs">
        ...
        <div id="navbar-filter" class="navbar-collapse collapse">
            <ul class="nav navbar-nav element-active-slate-400">
                <li class="active"><a data-toggle="tab" href="#open" aria-expanded="false"><i class="far fa-ticket position-left"></i> Open Tickets {!! ticketCountIcon('Open', $ticketCount) !!}</a></li>
