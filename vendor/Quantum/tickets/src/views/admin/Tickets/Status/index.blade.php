    ...
    <div class="col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('method' => 'POST', 'url' => '/admin/ticket/status/create', 'class' => 'form-horizontal', 'id' => 'status-create', 'autocomplete' => 'off')) !!}
@include('admin.Tickets.Status.statusForm')
                    <div class="form-group">
                        <div class="col-lg-10">
                            {!! Form::button('<i class="far fa-save"></i> Create New Status', array('type' => 'submit', 'class' => 'btn btn-primary')) !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
