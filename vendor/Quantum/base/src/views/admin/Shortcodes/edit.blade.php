        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model($shortcode, array('method' => 'POST', 'url' => '/admin/shortcode/'.$shortcode->id.'/update')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('replace', $shortcode->callback, array('class' => 'form-control', 'id' => 'replace', 'required')) !!}
                    ...
                    <div class="row">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Edit Shortcode<i class="far fa-save position-right"></i></button>
                        </div>
