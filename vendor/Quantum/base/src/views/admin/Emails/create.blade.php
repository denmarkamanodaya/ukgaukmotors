...
@section('page-header')
    <span class="text-semibold">System Email</span> - Create New Email
@stop
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model(array('method' => 'POST', 'url' => '/admin/email/')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                @if ($errors->has('title'))
                                    <span class="help-block" for="subject">{{ $errors->first('title') }}</span>
                                @endif
                                <span class="help-block">Title is used as an identifier for this email.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::label('content_text', 'Content (Text)', array('class' => 'control-label')) !!}
                                {!! Form::textarea('content_text', null, array('class' => 'form-control', 'id' => 'content_text')) !!}
                                @if ($errors->has('content_text'))
                                    <span class="help-block" for="content_text">{{ $errors->first('content_text') }}</span>
                                @endif
                                <span class="help-block">Text here is also used for notifications.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Save Email<i class="far fa-save position-right"></i></button>
                        </div>
