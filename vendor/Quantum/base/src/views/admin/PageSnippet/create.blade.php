...
@section('breadcrumbs')
    {!! breadcrumbs(array('Dashboard' => '/admin/dashboard', 'Page Snippet' => '/admin/pagesnippet', 'Create' => 'is_current')) !!}
@stop

@section('page-header')
    <span class="text-semibold">Page Snippet</span> - Create a new snippet
@stop
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(array('method' => 'POST', 'url' => '/admin/pagesnippet/snippet/create')) !!}
                    {!! Form::hidden('type', 'snippet') !!}
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Save Snippet<i class="far fa-save position-right"></i></button>
                        </div>
