    ...
    <script>
        $('.confirmDelete').on('click', function() {
            ...
            bootbox.confirm({
                ...
                message: 'Are you sure you want to delete this page snippet item?',
                callback: function(result) {
                    if (result) {
                        window.location = '{{url('admin/pagesnippet/snippet/')}}/' + id + '/delete';
                    }
                }
            });
        });
...
@section('breadcrumbs')
    {!! breadcrumbs(array('Dashboard' => '/admin/dashboard', 'Page Snippet' => 'is_current')) !!}
@stop

@section('page-header')
    <span class="text-semibold">Page Snippet</span> - Manage Snippets
@stop
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h6 class="panel-title">Snippets</h6>
                ...
                <div class="panel-body">
                    <a href="{{url('/admin/pagesnippet/snippet/create')}}">
                    ...
                    {!! Form::open(array('method' => 'POST', 'url' => '/admin/pagesnippet/', 'class' => 'form-horizontal')) !!}
                    ...
                    <table class="table datatable-ajax table-bordered table-striped table-hover" id="users-table">
                        ...
                        @foreach($news as $newsItem)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('admin/pagesnippet/snippet/'.$newsItem->id.'/edit')}}" class="btn bg-teal-400 btn-labeled" type="button"><b><i class="far fa-pencil"></i></b> Edit</a>
