        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model($membership, array('method' => 'POST', 'url' => '/admin/membership/'.$membership->id.'/update')) !!}
                        ...
                        <div class="col-md-6">
                            ...
                            @foreach($roles as $roleid => $role)
                                <div class="checkbox">
                                    ...
                                    @if($role != 'Member')
                                        <label>
                                            <input type="checkbox" name="roles[]" value="{{$roleid}}" class="styled" @if( in_array($roleid, $memRoles) ) checked='checked' @endif>
                                            {!! $role !!}
                                        </label>
                                    @endif
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @foreach($roles as $roleid => $role)
                                <div class="checkbox">
                                    @if($role != 'Member')
                                        <label>
                                            <input type="checkbox" name="roles_to_remove[]" value="{{$roleid}}" class="styled" @if( in_array($roleid, $memRolesRemove) ) checked='checked' @endif>
                                            {!! $role !!}
                                        </label>
                                    @endif
                                </div>
                    ...
                    <div class="free_membership_inputs">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>
                                        <input type="checkbox" name="register_default" value="1" id="register_default" @if( $membership->register_default == 1) checked='checked' @endif>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <label>
                                    <input type="checkbox" name="expires" value="1" id="expires" @if( $membership->expires == 1) checked='checked' @endif>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row paid_membership_inputs">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <label>
                                                <input type="checkbox" name="subscription" value="1" id="subscription" @if( $membership->subscription == 1) checked='checked' @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="expired_remove_roles" value="1" @if( $membership->expired_remove_roles == 1) checked='checked' @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="expired_change_status" value="1" @if( $membership->expired_change_status == 1) checked='checked' @endif>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @foreach($roles as $roleid => $role)
                                            <div class="checkbox">
                                                @if($role != 'Member')
                                                    <label>
                                                        <input type="checkbox" name="expired_add_roles[]" value="{{$roleid}}" class="styled" @if( in_array($roleid, $memRolesAdd) ) checked='checked' @endif>
                                                        {!! $role !!}
                                                    </label>
                                                @endif
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>
                                            <input type="checkbox" name="email_validate" value="1" @if( $membership->email_validate == 1) checked='checked' @endif>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>
                                            <input type="checkbox" name="login_after_register" value="1" @if( $membership->login_after_register == 1) checked='checked' @endif>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>
                                            <input type="checkbox" name="allow_user_signups" value="1" id="allow_user_signups" @if( $membership->allow_user_signups == 1) checked='checked' @endif>
                                            Allow User Signups
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>
                                            <input type="checkbox" name="display_in_collections" value="1" id="display_in_collections" @if( $membership->display_in_collections == 1) checked='checked' @endif>
                    ...
                    <div class="row">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Edit The Membership<i class="far fa-save position-right"></i></button>
                        </div>
                    </div>
