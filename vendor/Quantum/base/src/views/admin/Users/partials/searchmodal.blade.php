    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(array('method' => 'POST', 'url' => '/admin/users/search')) !!}
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            {!! Form::label('transactionid', 'Paypal Transaction ID', array('class' => 'control-label')) !!}
                            {!! Form::text('transactionid', null, array('class' => 'form-control', '')) !!}
                            @if ($errors->has('transactionid'))
                                <span class="help-block validation-error-label" for="transactionid">{{ $errors->first('transactionid') }}</span>
                            @endif
                        </div>
