...
@section('breadcrumbs')
    {!! breadcrumbs(array('Dashboard' => '/admin/dashboard', 'News' => '/admin/news', 'Edit' => 'is_current')) !!}
@stop

@section('page-header')
    <span class="text-semibold">News</span> - Edit a news Item
@stop
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model($newsItem,array('method' => 'POST', 'url' => '/admin/newsItem/'.$newsItem->id.'/update')) !!}
