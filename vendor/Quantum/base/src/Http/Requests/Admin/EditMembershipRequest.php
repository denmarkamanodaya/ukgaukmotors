...
class EditMembershipRequest extends FormRequest
{
    use RequestResponse;
    ...
    public function rules()
    {
        ...
        return [
            ...
            'amount' => 'required_if:type,paid|regex:/\b\d{1,3}(?:,?\d{3})*(?:\.\d{2})?\b/',
            'subscription' => 'boolean',
            'expires' => 'boolean',
            'subscription_period_amount' => 'nullable|required_if:subscription,1|string',
