...
class PageSnippet extends Controller
{
    ...
    public function index($area = false)
    {
        ...
        $news = \Quantum\base\Models\News::where('type', 'snippet')->where('area', $area)->tenant()->latest()->paginate(20);
        return view('base::admin.PageSnippet.index', compact('news', 'area'));
    }
    ...
    public function create()
    {
        ...
        return view('base::admin.PageSnippet.create', compact('roles', 'helptext'));
    }
    ...
    public function store(\Quantum\base\Http\Requests\Admin\CreateNewsItemRequest $request)
    {
        ...
        return redirect('admin/pagesnippet/'.$newsItem->area);
    }
    ...
    public function edit($id)
    {
        ...
        $helptext['news_content'] = HelpText::slug('news_content')->first();
        return view('base::admin.PageSnippet.edit', compact('newsItem','roles','selectedRoles', 'helptext'));
    }
    ...
    public function update(\Quantum\base\Http\Requests\Admin\UpdateNewsRequest $request, $id)
    {
        ...
        return redirect('/admin/pagesnippet/snippet/'.$id.'/edit');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/pagesnippet/'.$area);
    }
}
