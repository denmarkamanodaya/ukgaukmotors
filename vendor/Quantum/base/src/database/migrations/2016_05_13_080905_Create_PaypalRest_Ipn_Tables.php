...
class CreatePaypalRestIpnTables extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ipn_log', function (Blueprint $table) {
            ...
            $table->decimal('remaining_settle', 9, 2)->nullable();
            ...
            $table->decimal('mc_fee', 9, 2)->nullable();
            $table->decimal('mc_gross', 9, 2)->nullable();
            $table->decimal('mc_handling', 9, 2)->nullable();
            $table->decimal('mc_shipping', 9, 2)->nullable();
            $table->decimal('payment_fee', 9, 2)->nullable();
            $table->decimal('payment_gross', 9, 2)->nullable();
            $table->decimal('settle_amount', 9, 2)->nullable();
            ...
            $table->string('recurring_payment_id', 40)->nullable();
            $table->text('full_ipn');
            $table->timestamps();
            $table->softDeletes();
        });
