...
class IpnListener
{
    ...
    protected function curlPost($encoded_data)
    {
        ...
        if ($this->verify_ssl) {
            ...
            $path = base_path();
            curl_setopt($ch, CURLOPT_CAINFO, $path. '/vendor/Quantum/base/src/Repositories/Gateway/PaypalRest/cert/api_cert_chain.crt');
        }
    ...
    public function buildPost($request)
    {
