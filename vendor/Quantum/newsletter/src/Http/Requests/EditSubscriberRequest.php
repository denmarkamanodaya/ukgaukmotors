...
class EditSubscriberRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'removeFromNewsletter' => 'boolean',
            'moveToNewsletter' => 'numeric',
            'otherNewsletters' => 'array',
        ];
    }
    ...
    public function sanitize()
    {
        ...
        if(isset($input['moveToNewsletter'])) $input['moveToNewsletter'] = filter_var($input['moveToNewsletter'], FILTER_SANITIZE_STRING);
        $this->replace($input);
    }
}
