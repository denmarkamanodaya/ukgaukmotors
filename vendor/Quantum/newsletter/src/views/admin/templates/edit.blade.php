...
@section('breadcrumbs')
    {!! breadcrumbs(array('Dashboard' => '/admin/dashboard', 'Newsletter' => '/admin/newsletter', 'Templates' => '/admin/newsletter/templates', 'Edit' => 'is_current')) !!}
@stop

@section('page-header')
    <span class="text-semibold">Newsletter</span> - Edit a Template
@stop
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model($template, array('method' => 'POST', 'url' => '/admin/newsletter/template/'.$template->slug.'/edit')) !!}
                    ...
                    <div class="row">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Edit Newsletter Template<i class="far fa-save position-right"></i></button>
                        </div>
