...
@section('breadcrumbs')
    {!! breadcrumbs(array('Dashboard' => '/admin/dashboard', 'Newsletter' => '/admin/newsletter', 'Create' => 'is_current')) !!}
@stop

@section('page-header')
    <span class="text-semibold">Newsletter</span> - Create a new Newsletter
@stop
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <span class="help-block">By selecting a template you can populate all email sections below with is content.<br>This will overwrite anything that is currently in these sections so take note beforehand of whats already there.</span>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(array('method' => 'POST', 'url' => '/admin/newsletter/create')) !!}
                    ...
                    @if($templates && count($templates) > 0)
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('newsletter_theme_load', 'Load A Template', array('class' => 'control-label')) !!}
                                    {!! Form::select('newsletter_theme_load', $templates, null, array('class' => 'form-control', 'required')) !!}
                                    @if ($errors->has('newsletter_theme_load'))
                                        <span class="help-block validation-error-label" for="title">{{ $errors->first('newsletter_theme_load') }}</span>
                                    @endif
                                    <span class="help-block">Choose the email theme.</span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @foreach($newsletters as $id => $newsletter)
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('newsletter_no_join[]', $id, null, array('class' => 'styled')) !!} {!! $newsletter !!}
                                            </label>
                                        </div>
                                    @endforeach
                        ...
                        <div class="col-md-12">
                            ...
                            <table id="role_change" class="table table-striped table-bordered table-hover invoice_items">
                                ...
                                <tr class="repeat no-display" id="{!! $i !!}-repeatable">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            {!! Form::select("role_action[$i]", ['gain' => 'Gain', 'lose' => 'Lose'],'gain', array('class' => 'form-control mt-15')) !!}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            {!! Form::select("role_id[$i]", $roles,'3', array('class' => 'form-control mt-15')) !!}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('email_from', Settings::get('site_email_address'), array('class' => 'form-control', 'required')) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('email_from_name', Settings::get('site_email_from_name'), array('class' => 'form-control', 'required')) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('welcome_email_subject', config('newsletter.welcome_email_subject'), array('class' => 'form-control', 'required')) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::textarea('welcome_email', config('newsletter.welcome_email'), array('class' => 'form-control')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('confirmation_email_subject', config('newsletter.confirmation_email_subject'), array('class' => 'form-control', 'required')) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::textarea('confirmation_email', config('newsletter.confirmation_email'), array('class' => 'form-control', 'required')) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('unsubscribe_email', config('newsletter.unsubscribe_email'), array('class' => 'form-control')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::textarea('subscribed_page', config('newsletter.subscribed_page'), array('class' => 'form-control', 'required')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('unsubscribed_page', config('newsletter.unsubscribed_page'), array('class' => 'form-control', 'required')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('confirmed_email', config('newsletter.confirmed_email_page'), array('class' => 'form-control', 'required')) !!}
                        ...
                        <div class="col-md-12">
                            ...
                            <span class="input-group-btn">
                                ...
                                <i class="far fa-image"></i> Choose
                                    ...
                                    {!! Form::text('featured_image', null, array('class' => 'form-control', 'id' => 'thumbnail')) !!}
                    ...
                    <div class="row">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Create Newsletter Campaign<i class="far fa-save position-right"></i></button>
                        </div>
