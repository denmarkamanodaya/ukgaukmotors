    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(array('method' => 'POST', 'url' => '/admin/newsletter/'.$newsletter->slug.'/responder/create')) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                {!! Form::number('interval_amount', 0, array('class' => 'form-control', 'required', 'min' => 0)) !!}
                                @if ($errors->has('html_message'))
                                    <span class="help-block validation-error-label" for="title">{{ $errors->first('html_message') }}</span>
                                @endif
                    ...
                    <div class="row">
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Create Newsletter Responder<i class="far fa-save position-right"></i></button>
                        </div>
