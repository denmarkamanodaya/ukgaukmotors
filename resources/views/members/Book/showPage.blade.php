...
@section('breadcrumbs')
        {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Books' => '/members/books', $book->title => '/members/book/'.$book->slug, $chapter->title => '/members/book/'.$book->slug.'/'.$chapter->slug, $page->title => 'is_current']) !!}
@stop
    ...
    <div class="row">
        <div class="section-content col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="content-area">
                    ...
                    <div class="col-md-12">
                        ...
                        @else
                            @if($page->public_view == 1)
                                {!! $page->content !!}
                            @else
                                @include('members.NeedUpgrade.textBookOneLine')
                            @endif
                        @endif
                ...
                @include('members.Book.partials.nav')
