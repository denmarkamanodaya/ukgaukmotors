...
@section('breadcrumbs')
        {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Books' => 'is_current']) !!}
@stop
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-20">
                        <div class="blog-listing medium-view">
                            ...
                            <div class="cs-media">
                                <figure>
                                    <a href="{!! url('/members/book/'.$book->slug) !!}"><img src="{{ url($book->front_cover) }}" alt="" /></a>
                                </figure>
                            </div>
                            @endif
                            <div class="cs-text">
                                <div class="post-title">
                                    <h4><a href="{!! url('/members/book/'.$book->slug) !!}">{{ $book->title }}</a></h4>
                                </div>
                                <p>{!! $book->content !!}</p>
                                <div class="widget-text col-md-12">
                                    <div class="row">
                                    <div class="col-md-6"><a class="contact-btn cs-color" href="{!! url('/members/book/'.$book->slug.'/details') !!}">View Details</a></div>
                                    <div class="col-md-6 text-right"><a class="contact-btn cs-color" href="{!! url('/members/book/'.$book->slug) !!}">Read Book</a></div>
                                    </div>
                                </div>
