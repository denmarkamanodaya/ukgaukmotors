...
@section('breadcrumbs')
    {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Books' => '/members/books', $book->title => '/members/book/'.$book->slug, $chapter->title => 'is_current']) !!}
@stop
            ...
            <div class="content-area">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <div class="text-center mb-20"><h5>{{$chapter->title}}</h5></div>
                        @if($chapter->pages)
