...
@if(Auth::user())
@if(Auth::user()->hasRole(Settings::get('main_content_role')))margin-top:0px;-webkit-box-shadow: 0 0 0px rgba(0,0,0,.4), inset 0px 0px rgba(255,255,255,.3);-moz-box-shadow: 0 0 0px rgba(0,0,0,.4), inset 0px 0px rgba(255,255,255,.3);box-shadow: 0 0 0px rgba(0,0,0,.4), inset 0px 0px rgba(255,255,255,.3);
@endif
