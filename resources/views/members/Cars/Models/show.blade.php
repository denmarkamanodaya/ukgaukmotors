...
@section('breadcrumbs')
    {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Motorpedia' => '/members/motorpedia', $carMake->name => '/members/motorpedia/car-make/'.$carMake->slug.'/#models', $carModel->name => 'is_current']) !!}
@stop
                                        ...
                                        <div class="row">
                                            @foreach($carModel->variants as $variant)
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-5">
                                                    <a href="{{ url('members/car-make/'.$carMake->slug.'/'.$carModel->slug.'/'.$variant->id) }}">{{ $variant->model_desc  }}</a>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
