    ...
    <script>
        $(function() {
            $('#vehiclemodels-table').DataTable({
                ...
                columns: [
                    {data: 'featureImage', name: 'featureImage', searchable: false},
...
@section('breadcrumbs')
    {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Car Data' => '/members/car-data', $carMake->name => 'is_current']) !!}
@stop
                    ...
                    <div class="woocommerce-tabs wc-tabs-wrapper car-data-tab-adjust">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="models">
                                ...
                                <table class="table datatable-ajax" id="vehiclemodels-table">
                                    <thead>
                                    <tr>
                                        <th class=""></th>
                                        <th class=""></th>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="blog-listing medium-view ">
                                                        ...
                                                        @if($model->description->featured_image != '')
                                                            <div class="cs-media">
                                                                <figure>
                                                                    <a href="{!! url('members/car-make/'.$carMake->slug.'/'.$model->slug) !!}"><img src="{{ featuredImage($model->description->featured_image) }}" alt="" /></a>
                                                                </figure>
                                                            </div>
                                                        @endif
                                                        <div class="cs-text">
                                                            <div class="post-title">
                                                                <h4><a href="{!! url('members/car-make/'.$carMake->slug.'/'.$model->slug) !!}">{{ $model->name }}</a></h4>
                                                            </div>
                                                            <p>{!! makeSummary($model->description->content) !!}</p>
                                                            <div class="text-right widget-text"><a class="contact-btn cs-color" href="{!! url('members/car-make/'.$carMake->slug.'/'.$model->slug) !!}">View Details</a></div>
                                                        </div>
                                                            @else
                                                            <div class="cs-text">
                                                                <div class="post-title">
