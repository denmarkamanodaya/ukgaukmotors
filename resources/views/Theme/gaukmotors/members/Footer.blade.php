            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="widget widget-our-partners">
                        ...
                        <a href="{!! url('/members/upgrade') !!}"><img class="img-responsive" alt="Upgrade at gauk motor auctions uk" height="120" src="{!! url('/images/UpgradeFooter550X120.jpg') !!}" width="550" /></a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="copyright-text">
                        <p>&copy; {{ date('Y') }} GAUK Motors. GAUK™ is an established Trade Mark. All Rights Reserved. No part of this site shall be copied or reproduced in any way whatsoever without the written permission of GAUK Media Ltd</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
