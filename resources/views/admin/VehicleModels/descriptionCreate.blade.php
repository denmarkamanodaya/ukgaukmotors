        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('method' => 'POST', 'url' => '/admin/vehicle-model/'.$vehicleModel->id.'/description', 'files' => true, 'id' => 'DescriptionForm')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('content', $vehicleModel->description, array('class' => 'form-control cke_1 cke cke_reset cke_chrome cke_editor_editor-full cke_ltr cke_browser_gecko', 'id' => 'content')) !!}
