...
@section('page-header')
    <span class="text-semibold">Vehicle Features</span> - Create a new category
@stop
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse in" id="accordion-control-right-group1">
                        <div class="panel-body">
                            {!! Form::open(array('method' => 'POST', 'url' => '/admin/vehicle-features/create', 'id' => 'FeatureCreate', 'autocomplete' => 'off')) !!}
                            ...
                            <div class="row">
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary">Create Category<i class="far fa-save position-right"></i></button>
                                </div>
