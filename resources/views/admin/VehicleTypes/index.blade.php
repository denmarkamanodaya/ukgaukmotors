...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h6 class="panel-title">Create A Vehicle Type</h6>
                    <div class="heading-elements">
                ...
                <div class="panel-body">
                    {!! Form::open(array('method' => 'POST', 'url' => '/admin/vehicle-type/create', 'class' => 'form-horizontal', 'id' => 'vehicle-type-create')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {!! Form::button('<i class="far fa-save"></i> Create Vehicle Type', array('type' => 'submit', 'class' => 'btn btn-primary')) !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
