...
@section('content')
@include('admin.VehicleMakes.partials.topLinks')
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::model($vehicleMake,array('method' => 'POST', 'url' => '/admin/vehicle-make/'.$vehicleMake->slug.'/description', 'files' => true, 'id' => 'DescriptionForm')) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('content', $vehicleMake->description->content, array('class' => 'form-control cke_1 cke cke_reset cke_chrome cke_editor_editor-full cke_ltr cke_browser_gecko', 'id' => 'content')) !!}
                        ...
                        <div class="col-md-6">
                            @if($vehicleMake->description->featured_image)
                            <div class="row">
                                <img id="thumbnail_featured_image" class="" style="max-height:100px;" src="{{ featured_image($vehicleMake->description->featured_image) }}">
                            </div>
                                <div class="row">
                                    <label>
