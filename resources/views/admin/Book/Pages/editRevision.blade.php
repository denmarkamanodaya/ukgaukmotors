        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body bg-info">
                    ...
                    <div class="col-md-4"><a href="{!! url('admin/book/'.$book->id.'/chapter/'.$chapter->id.'/page/'.$page->id.'/edit') !!}"><button class="btn btn-default btn-xs" type="button"><i class="far fa-retweet position-left"></i> Return To Original Page</button></a></div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse in" id="accordion-control-right-group1">
                        <div class="panel-body">
                            {!! Form::model($pageRevision, array('method' => 'POST', 'url' => '/admin/book/'.$book->id.'/chapter/'.$chapter->id.'/page/'.$page->id.'/edit', 'id' => 'PageManage', 'files' => true, 'autocomplete' => 'off')) !!}
