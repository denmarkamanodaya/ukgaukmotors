...
@section('breadcrumbs')
    {!! breadcrumbs(array('Dashboard' => '/admin/dashboard', 'Books' => '/admin/books', 'Book Chapters' => '/admin/book/'.$book->id.'/manage', 'Chapter' => '/admin/book/'.$book->id.'/chapter/'.$chapter->id.'/pages', 'Create Page' => 'is_current')) !!}
@stop

@section('page-header')
    <span class="text-semibold">Book</span> - Create a new page
@stop
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse in" id="accordion-control-right-group1">
                        <div class="panel-body">
                            {!! Form::open(array('method' => 'POST', 'url' => '/admin/book/'.$book->id.'/chapter/'.$chapter->id.'/createPage', 'id' => 'PageManage', 'files' => true, 'autocomplete' => 'off')) !!}
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            {!! Form::select('public_view', array('0' => 'Yes', '1' => 'No'),0, array('class' => 'form-control', 'id' => 'public_view')) !!}
                        ...
                        <div class="row">
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary">Create Page<i class="far fa-save position-right"></i></button>
                            </div>
