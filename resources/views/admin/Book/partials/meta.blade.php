<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title">
            <a href="#accordion-control-right-group3" data-parent="#accordion-control-right" data-toggle="collapse" class="collapsed">Book Meta</a>
        </h6>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('description', isset($book->meta->description)? $book->meta->description : '', array('class' => 'form-control')) !!}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('keywords', isset($book->meta->keywords)? $book->meta->keywords : '', array('class' => 'form-control')) !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('type', ['website' => 'Website', 'article' => 'Article'], isset($book->meta->type)? $book->meta->type : '', array('class' => 'form-control')) !!}
                        @if ($errors->has('type'))
