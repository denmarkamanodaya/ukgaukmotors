...
@section('breadcrumbs')
    {!! breadcrumbs(array('Dashboard' => '/admin/dashboard', 'Books' => '/admin/books', 'Book Chapters' => '/admin/book/'.$book->id.'/manage', 'Create Chapter' => 'is_current')) !!}

@stop

@section('page-header')
    <span class="text-semibold">Book</span> - Create a new chapter
@stop
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse in" id="accordion-control-right-group1">
                        <div class="panel-body">
                            {!! Form::open(array('method' => 'POST', 'url' => '/admin/book/'.$book->id.'/createChapter', 'id' => 'PageManage', 'files' => true, 'autocomplete' => 'off')) !!}
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary">Create Chapter<i class="far fa-save position-right"></i></button>
                            </div>
