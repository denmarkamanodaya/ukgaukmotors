...
@section('breadcrumbs')
    {!! breadcrumbs(array('Dashboard' => '/admin/dashboard', 'Vehicles' => 'is_current')) !!}
@stop
                    ...
                    <table class="table datatable-ajax table-bordered table-striped table-hover" id="users-table">
                        ...
                        @foreach($vehicles as $vehicle)
                            <tr>
                                ...
                                <td><a href="{{ url('admin/vehicle/'.$vehicle->slug.'/auctionEdit')}}" class="btn bg-teal-400 btn-labeled" type="button"><b><i class="fas fa-car"></i></b> Details</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
