...
@section('breadcrumbs')
    {!! breadcrumbs(['Home' => url('/'), 'Books' => '/books', $book->title => '/book/'.$book->slug, $chapter->title => 'is_current']) !!}
@stop
                        ...
                        @if($chapter->pages)
                            ...
                            <ul class="bookList">
                                @foreach($chapter->pages as $page)
                                    <li><a href="{!! url('/book/'.$book->slug.'/'.$chapter->slug.'/'.$page->slug) !!}">{{$page->title}} {!! hasPreview($page->public_view) !!}</a></li>
