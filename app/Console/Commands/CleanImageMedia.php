...
class CleanImageMedia extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'gauk:cleanImageMedia';
     ...
     * @var string
     */
    protected $description = 'Remove old media';
    /**
    ...
    {
        $this->auctionImportService->removeOldMedia();
    }
}
